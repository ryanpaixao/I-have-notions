...
import { databaseReqParams, groupByType } from '../utils/database.js';
...
export const getNotionData = async (req, res) => {
  try {
    ...
    const formatedData = groupByType(response.results);
...
// Get Query Notion Database (Glossary)
export const getNotionGlossaryData = async (req, res) => {
  try {
    const reqPayload = {
      database_id: req.params.database_id,
      page_size: 100,
